  ...
  return (
    <div className="report-viewer">
      <nav className="report-toolbar" aria-label="Report actions">
        <Link className="report-toolbar__back" href="/reports">
          <ArrowLeft aria-hidden="true" size={16} /> Report library
        </Link>
        <div className="report-toolbar__state">
          <FileCheck2 aria-hidden="true" size={16} />
          <span><strong>{lead.name}</strong><small>Client-ready audit</small></span>
        </div>
